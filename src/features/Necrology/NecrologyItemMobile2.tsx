...
const NecrologyItemMobile2 = ({ item, solscanLink }: NecrologyItemProps) => {
  return (
    <div className="md:hidden">
      <div className="flex justify-between pt-3">
        <div className="text-left">
          <div className="text-secondary opacity-50 text-xs">{item._createdAt}</div>
          <div className="mt-1">
            <LazyLoad height={24} classNamePrefix="inline lazyload">
              <img className="inline rounded-md h-6 w-6" src={ImgixClient.buildURL(item.img, { w: 24, fm: 'jpg', q: 50 })} alt="IDImg" />
            </LazyLoad>
...
export default NecrologyItemMobile2;
