...
import { INecrologyData } from 'features/Necrology/api/NecrologyModel';
            ...
            <div key={`mortuaryItem${index}`}>
              <LazyLoad height={70} classNamePrefix=" w-full md:w-16 md:h-16 lazyload">
                <img
                  ...
                  src={recentNecrologiesData[index].thumbnail + '?h=70'}
          ...
          return (
            <div key={`mortuaryItem${index}`}>
              <LazyLoad height={70} classNamePrefix=" w-full md:w-16 md:h-16 lazyload">
                <img
                  className="inline w-full h-full object-cover opacity-40"
                  src={recentlyBurnedNFTs?.[index - recentNecrologiesData?.length].thumbnail + '?h=70'}
                  alt={`mortuaryItem${index}`}
                />
              </LazyLoad>
              <MortuaryDuration
