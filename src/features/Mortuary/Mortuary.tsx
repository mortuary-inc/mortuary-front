...
const MortuarySelect = ({ stats, isLoading, owner, voxelID }: IMortuaryProps) => {
  ...
  const { totalBurned, totalAsh, totalTax } = useBurnStat(stats, owner, voxelID);
          ...
          <div className="flex justify-between">
            <div>
              {!isEditable && !voxelSelected ? (
                ...
                <div className="text-third font-serif font-extralight text-2xl">{voxelSelected.metadata.data.name.replace('Mortuary Inc', '')}</div>
              )}
          ...
          <div className="flex mt-4 md:mt-0 justify-between">
            <div className="flex">
              ...
              <button
                ...
                onClick={() => scrollToID("Necrology_32532")}
              >
                View logs
              </button>
            </div>
